    ...
    private class MaxHeap {
        ...
        int siftDown(int i) {
            ...
            while (true) {
                ...
                // ищем наибольшего среди i, left, right
        ...
        void insert(Long value) {
            ...
            siftUp(heap.size() - 1);   // поднимаем на нужное место
        }

        Long extractMax() {
            if (heap.isEmpty()) return null;

            Long result = heap.get(0); // максимум всегда на вершине
            ...
            if (!heap.isEmpty())
                siftDown(0); // опускаем его на нужное место
